...
- Transição baseada em `opacity` + `transform: scaleY()` (não usa `display: none`)
- Evita "piscadas" e mantém o `gap` entre itens durante a animação
- Controle de visibilidade com `pointer-events` para melhor UX
...
👨‍💻 Desenvolvido por eu mesmo - João Tiago Desenvolvedor Front-End
Feito com muita atenção aos detalhes.

🔗 LinkedIn https://www.linkedin.com/in/jo%C3%A3o-tiago-mattos-silva-042189391/ | 📧 joaotiagomsprofissional@gmail.com
